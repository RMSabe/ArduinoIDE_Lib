...
class ST7920 {
	...
	private:
		static constexpr uint32_t _PAGE_SIZE_PIXELS = 16u;
		static constexpr uint32_t _PAGE_SIZE_BYTES = 2u;
		static constexpr uint32_t _HEIGHT_PIXELS = 32u;
		static constexpr uint32_t _WIDTH_PIXELS = 256u;
		static constexpr uint32_t _WIDTH_PAGES = _WIDTH_PIXELS/_PAGE_SIZE_PIXELS;
		static constexpr uint32_t _BUFFER_SIZE_PAGES = _WIDTH_PAGES*_HEIGHT_PIXELS;
		static constexpr uint32_t _BUFFER_SIZE_BYTES = _BUFFER_SIZE_PAGES*_PAGE_SIZE_BYTES;

		static constexpr uint32_t _N_WCHARS = 16u;
		static constexpr uint32_t _N_LINES = 2u;
		static constexpr uint32_t _N_CHARS = 2u*_N_WCHARS;

		static constexpr uint32_t _CMD_LONG_DELAY_US = 1024u;
		static constexpr uint32_t _CMD_SHORT_DELAY_US = 128u;
		static constexpr uint32_t _EN_DELAY_US = 1u;
		...
		uint16_t _page_buffer[_BUFFER_SIZE_PAGES];
	...
	public:
		...
		static constexpr uint32_t WIDTH = _WIDTH_PIXELS/2u;
		static constexpr uint32_t HEIGHT = _HEIGHT_PIXELS*2u;
		static constexpr uint32_t WIDTH_PAGES = _WIDTH_PAGES/2u;

		static constexpr uint32_t N_CHARS = _N_CHARS/2u;
		static constexpr uint32_t N_LINES = _N_LINES*2u;
		static constexpr uint32_t N_WCHARS = _N_WCHARS/2u;
};
