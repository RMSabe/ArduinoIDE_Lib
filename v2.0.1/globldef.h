...
__EXTERNC__ const uintptr_t PTR_MAX_VALUE __PROGMEM_DATA__;
__EXTERNC__ const uintptr_t PTR_MSB_VALUE __PROGMEM_DATA__;
__EXTERNC__ char textbuf[];
...
__EXTERNC__ bool _is_power2(uintptr_t value) __PROGMEM_CODE__;
...
__EXTERNC__ uintptr_t _get_closest_power2_floor(uintptr_t value) __PROGMEM_CODE__;
__EXTERNC__ uintptr_t _get_closest_power2_ceil(uintptr_t value) __PROGMEM_CODE__;
__EXTERNC__ uintptr_t _get_closest_power2_round(uintptr_t value) __PROGMEM_CODE__;
