...
__EXTERNC__ intptr_t cstr_getlength(const char *str) __PROGMEM_CODE__;
...
__EXTERNC__ intptr_t cstr_locatechar(const char *str, char c) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_compare(const char *str1, const char *str2) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_compare_upto_len(const char *str1, const char *str2, uintptr_t stop_index, bool fail_if_nolen) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_compare_upto_char(const char *str1, const char *str2, char stop_char, bool fail_if_nochar) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_copy(const char *input_str, char *output_str, uintptr_t bufferout_length) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_copy_upto_len(const char *input_str, char *output_str, uintptr_t bufferout_length, uintptr_t stop_index, bool append_nullchar) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_copy_upto_char(const char *input_str, char *output_str, uintptr_t bufferout_length, char stop_char, bool append_nullchar) __PROGMEM_CODE__;
...
__EXTERNC__ bool cstr_tolower(char *str, uintptr_t buffer_length) __PROGMEM_CODE__;
__EXTERNC__ bool cstr_toupper(char *str, uintptr_t buffer_length) __PROGMEM_CODE__;
